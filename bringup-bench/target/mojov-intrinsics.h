...
extern inline _u64e_t _add(_u64e_t src1, _u64e_t src2) __MOJOV_DEF_BIN_U64(_add, "add")
/* Computes integer addition with an immediate. Example: dst = src1 + 42u; */
extern inline _u64e_t _addi(_u64e_t src1, uint64_t src2) __MOJOV_DEF_BINI_U64(_addi, "add")
/* Computes integer subtraction. Example: dst = src1 - src2; */
extern inline _u64e_t _sub(_u64e_t src1, _u64e_t src2) __MOJOV_DEF_BIN_U64(_sub, "sub")
/* Computes integer subtraction with an immediate. Example: dst = src1 - 42u; */
extern inline _u64e_t _subi(_u64e_t src1, uint64_t src2) __MOJOV_DEF_BINI_U64(_subi, "sub")
/* Computes signed integer multiplication. Example: dst = src1 * src2; */
extern inline _u64e_t _mul(_u64e_t src1, _u64e_t src2) __MOJOV_DEF_BIN_U64(_mul, "mul")
/* Computes signed integer multiplication with an immediate. Example: dst = src1 * 42u; */
extern inline _u64e_t _muli(_u64e_t src1, uint64_t src2) __MOJOV_DEF_BINI_U64(_muli, "mul")
/* Computes unsigned integer multiplication. Example: dst = src1 * src2; */
extern inline _u64e_t _mulu(_u64e_t src1, _u64e_t src2) __MOJOV_DEF_BIN_U64(_mulu, "mul")
/* Computes unsigned integer multiplication with an immediate. Example: dst = src1 * 42u; */
extern inline _u64e_t _mului(_u64e_t src1, uint64_t src2) __MOJOV_DEF_BINI_U64(_mului, "mul")
/* Computes signed integer division. Example: dst = src1 / src2; */
extern inline _u64e_t _div(_u64e_t src1, _u64e_t src2) __MOJOV_DEF_BIN_U64(_div, "div")
/* Computes signed integer division with an immediate. Example: dst = src1 / 42; */
extern inline _u64e_t _divi(_u64e_t src1, int64_t src2) __MOJOV_DEF_BINI_U64(_divi, "div")
/* Computes unsigned integer division. Example: dst = src1 / src2; */
extern inline _u64e_t _divu(_u64e_t src1, _u64e_t src2) __MOJOV_DEF_BIN_U64(_divu, "divu")
/* Computes unsigned integer division with an immediate. Example: dst = src1 / 42u; */
extern inline _u64e_t _divui(_u64e_t src1, uint64_t src2) __MOJOV_DEF_BINI_U64(_divui, "divu")
/* Computes signed integer remainder. Example: dst = src1 % src2; */
extern inline _u64e_t _mod(_u64e_t src1, _u64e_t src2) __MOJOV_DEF_BIN_U64(_mod, "rem")
/* Computes signed integer remainder with an immediate. Example: dst = src1 % 42u; */
extern inline _u64e_t _modi(_u64e_t src1, uint64_t src2) __MOJOV_DEF_BINI_U64(_modi, "rem")
/* Computes unsigned integer remainder. Example: dst = src1 % src2; */
extern inline _u64e_t _modu(_u64e_t src1, _u64e_t src2) __MOJOV_DEF_BIN_U64(_modu, "remu")
/* Computes unsigned integer remainder with an immediate. Example: dst = src1 % 42; */
extern inline _u64e_t _modui(_u64e_t src1, int64_t src2) __MOJOV_DEF_BINI_U64(_modui, "remu")
...
extern inline _u64e_t _slt(_u64e_t src1, _u64e_t src2) __MOJOV_DEF_BIN_U64(_slti, "slt")
/* Computes signed src1 < an immediate. Example: dst = (int64_t)src1 < 42; */
extern inline _u64e_t _slti(_u64e_t src1, int64_t src2) __MOJOV_DEF_BINI_U64(_slt, "slt")
/* Computes unsigned src1 < src2. Example: dst = (uint64_t)src1 < (uint64_t)src2; */
extern inline _u64e_t _sltu(_u64e_t src1, _u64e_t src2) __MOJOV_DEF_BIN_U64(_sltu, "sltu")
/* Computes unsigned src1 < an immediate. Example: dst = (uint64_t)src1 < 42u; */
extern inline _u64e_t _sltui(_u64e_t src1, uint64_t src2) __MOJOV_DEF_BINI_U64(_sltui, "sltu")
/* Computes signed src1 > src2. Example: dst = (int64_t)src1 > (int64_t)src2; */
extern inline _u64e_t _sgt(_u64e_t src1, _u64e_t src2) { return _slt(src2, src1); }
/* Computes signed src1 > an immediate. Example: dst = (int64_t)src1 > 42; */
extern inline _u64e_t _sgti(_u64e_t src1, int64_t src2) { _u64e_t tmp = _enc(src2); return _slt(tmp, src1); }
/* Computes unsigned src1 > src2. Example: dst = (uint64_t)src1 > (uint64_t)src2; */
extern inline _u64e_t _sgtu(_u64e_t src1, _u64e_t src2) { return _sltu(src2, src1); }
/* Computes unsigned src1 > an immediate. Example: dst = (uint64_t)src1 > 42u; */
extern inline _u64e_t _sgtui(_u64e_t src1, uint64_t src2) { _u64e_t tmp = _enc(src2); return _sltu(tmp, src1); }
/* Computes signed src1 <= src2. Example: dst = (int64_t)src1 <= (int64_t)src2; */
extern inline _u64e_t _sle(_u64e_t src1, _u64e_t src2) { return _lnot(_slt(src2, src1)); }
/* Computes signed src1 <= an immediate. Example: dst = (int64_t)src1 <= 42; */
extern inline _u64e_t _slei(_u64e_t src1, int64_t src2) { return _lnot(_sgti(src1, src2)); }
/* Computes unsigned src1 <= src2. Example: dst = (uint64_t)src1 <= (uint64_t)src2; */
extern inline _u64e_t _sleu(_u64e_t src1, _u64e_t src2) { return _lnot(_sltu(src2, src1)); }
/* Computes unsigned src1 <= an immediate. Example: dst = (uint64_t)src1 <= 42u; */
extern inline _u64e_t _sleui(_u64e_t src1, uint64_t src2) { return _lnot(_sgtui(src1, src2)); }
/* Computes signed src1 >= src2. Example: dst = (int64_t)src1 >= (int64_t)src2; */
extern inline _u64e_t _sge(_u64e_t src1, _u64e_t src2) { return _lnot(_slt(src1, src2)); }
/* Computes signed src1 >= an immediate. Example: dst = (int64_t)src1 >= 42; */
extern inline _u64e_t _sgei(_u64e_t src1, int64_t src2) { return _lnot(_slti(src1, src2)); }
/* Computes unsigned src1 >= src2. Example: dst = (uint64_t)src1 >= (uint64_t)src2; */
extern inline _u64e_t _sgeu(_u64e_t src1, _u64e_t src2) { return _lnot(_sltu(src1, src2)); }
/* Computes unsigned src1 >= an immediate. Example: dst = (uint64_t)src1 >= 42u; */
extern inline _u64e_t _sgeui(_u64e_t src1, uint64_t src2) { return _lnot(_sltui(src1, src2)); }
...
extern inline _fp64e_t _fadd(_fp64e_t src1, _fp64e_t src2) __MOJOV_DEF_BIN_FP64(_fadd, "fadd.d")
/* Computes floating-point addition with an immediate. Example: dst = src1 + 42.0; */
extern inline _fp64e_t _faddi(_fp64e_t src1, double src2) __MOJOV_DEF_BINI_FP64(_faddi, "fadd.d")
/* Computes floating-point subtraction. Example: dst = src1 - src2; */
extern inline _fp64e_t _fsub(_fp64e_t src1, _fp64e_t src2) __MOJOV_DEF_BIN_FP64(_fsub, "fsub.d")
/* Computes floating-point subtraction with an immediate. Example: dst = src1 - 42.0; */
extern inline _fp64e_t _fsubi(_fp64e_t src1, double src2) __MOJOV_DEF_BINI_FP64(_fsubi, "fsub.d")
/* Computes floating-point multiplication. Example: dst = src1 * src2; */
extern inline _fp64e_t _fmul(_fp64e_t src1, _fp64e_t src2) __MOJOV_DEF_BIN_FP64(_fmul, "fmul.d")
/* Computes floating-point multiplication with an immediate. Example: dst = src1 * 42.0; */
extern inline _fp64e_t _fmuli(_fp64e_t src1, double src2) __MOJOV_DEF_BINI_FP64(_fmuli, "fmul.d")
/* Computes floating-point division. Example: dst = src1 / src2; */
extern inline _fp64e_t _fdiv(_fp64e_t src1, _fp64e_t src2) __MOJOV_DEF_BIN_FP64(_fdiv, "fdiv.d")
/* Computes floating-point division with an immediate. Example: dst = src1 / 42.0; */
extern inline _fp64e_t _fdivi(_fp64e_t src1, double src2) __MOJOV_DEF_BINI_FP64(_fdivi, "fdiv.d")
...
extern inline _u64e_t _fseq(_fp64e_t src1, _fp64e_t src2) __MOJOV_DEF_REL_FP64(_fseq, "feq.d")
/* Computes floating-point equality with an immediate. Example: dst = src1 == 42.0; */
extern inline _u64e_t _fseqi(_fp64e_t src1, double src2) __MOJOV_DEF_RELI_FP64(_fseqi, "feq.d")
...
extern inline _u64e_t _fslt(_fp64e_t src1, _fp64e_t src2) __MOJOV_DEF_REL_FP64(_fslt, "flt.d")
/* Computes floating-point less-than with an immediate. Example: dst = src1 < 42.0; */
extern inline _u64e_t _fslti(_fp64e_t src1, double src2) __MOJOV_DEF_RELI_FP64(_fslti, "flt.d")
/* Computes floating-point less-than-or-equal. Example: dst = src1 <= src2; */
extern inline _u64e_t _fsle(_fp64e_t src1, _fp64e_t src2) __MOJOV_DEF_REL_FP64(_fsle, "fle.d")
/* Computes floating-point less-than-or-equal with an immediate. Example: dst = src1 <= 42.0; */
extern inline _u64e_t _fslei(_fp64e_t src1, double src2) __MOJOV_DEF_RELI_FP64(_fslei, "fle.d")
