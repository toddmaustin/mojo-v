...
2. **Spike (Instruction Set Simulator) Implementation** – Mojo-V integrated into `riscv-isa-sim`, nearly feature-complete.  
...
3. **Mojo-V Bringup-Bench Benchmarks** — Hand-coded examples (e.g., bubble-sort) showing Mojo-V working secret computation
